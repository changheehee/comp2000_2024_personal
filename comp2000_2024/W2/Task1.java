...
public class Task1 extends JPanel {
    ...
    public Task1() {
        ...
        // Add mouse motion listener to track the mouse movement
        ...
        Timer timer = new Timer(5, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!mousePosition.isEmpty()) {
                    mousePosition.poll(); // Remove the oldest point
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (currentMousePosition != null) { 
            ...
            g.fillRect(x, y, gridSize, gridSize); // draw square in calculated coordinates
        }
